...
export default {
    ...
    setup() {
        ...
        const fetchGrandTotal = async () => {
            try {
                const response = await fetch('/api/method/go1_vendor.sales.get_purchase_order_grand_total');
        ...
        const fetchOpenRfqs = async () => {
            try {
                const response = await fetch('/api/method/go1_vendor.sales.get_pending_quotation_count');
                const data = await response.json();
        ...
        const pendingInvoiceCount = async () => {
            try {
                const response = await fetch('/api/method/go1_vendor.sales.get_pending_invoice');
        ...
        const fetchPendingInwards = async () => {
            try {
                const response = await fetch('/api/method/go1_vendor.sales.get_pending_inwards');
                const data = await response.json();
        ...
        const fetchPurchaseOrderAnalysis = async () => {
            try {
                const response = await fetch('/api/method/go1_vendor.sales.get_purchase_order_status_analysis');
                const data = await response.json();
        ...
        const fetchMaterialRequestStatus = async () => {
            try {
                const response = await fetch('/api/method/go1_vendor.sales.get_quotation_status_counts');
                const data = await response.json();
        ...
        return {
            ...
            lineChartData,
            lineChartOptions,
            materialRequestChartData,
            materialRequestChartOptions,
            pendingInvoice,
            pendingInwards,
            topSoldItemsChartData,
            topSoldItemsChartOptions,
            openRfqs,
        };
    },
};
